...
export const codFaqItems: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Add items to your cart, then proceed to checkout. Enter your delivery details, choose Cash on Delivery, and pay the delivery person in cash when you receive your order.",
  },
  {
